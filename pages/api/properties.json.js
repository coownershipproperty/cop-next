...
export default async function handler(req, res) {
  ...
  try {
    ...
    const feed = {
      ...
      description: `Complete public feed of all live fractional co-ownership listings on co-ownership-property.com — ${items.length} properties across Europe, the USA and Mexico. Updated continuously; cached at the edge for 1 hour.`,
      provider: {
        '@type': 'Organization',
