...
const FACTS_COPY = {
  en: {
    ...
    nights_uncapped: 'c. 45 nights a year',
  ...
  es: {
    ...
    nights_uncapped: 'c. 45 noches al año',
  ...
  fr: {
    ...
    nights_uncapped: 'env. 45 nuits par an',
  ...
  de: {
    ...
    nights_uncapped: 'ca. 45 Nächte im Jahr',
  ...
  it: {
    ...
    nights_uncapped: 'ca. 45 notti l’anno',
  ...
  nl: {
    ...
    nights_uncapped: 'ca. 45 nachten per jaar',
  ...
  pt: {
    ...
    nights_uncapped: 'c. 45 noites por ano',
  ...
  sv: {
    ...
    nights_uncapped: 'ca 45 nätter om året',
  ...
  da: {
    ...
    nights_uncapped: 'ca. 45 nætter om året',
  ...
  no: {
    ...
    nights_uncapped: 'ca. 45 netter i året',
    nights_fraction: (n) => `Din 1/${n} av året`,
