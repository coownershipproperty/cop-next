...
const FACTS_COPY = {
  en: {
    ...
    nights_uncapped: 'No annual night limit',
  ...
  es: {
    ...
    nights_uncapped: 'Sin límite anual de noches',
  ...
  fr: {
    ...
    nights_uncapped: 'Pas de plafond annuel de nuits',
  ...
  de: {
    ...
    nights_uncapped: 'Keine jährliche Nächte-Obergrenze',
  ...
  it: {
    ...
    nights_uncapped: 'Nessun limite annuo di notti',
  ...
  nl: {
    ...
    nights_uncapped: 'Geen jaarlijkse nachtenlimiet',
  ...
  pt: {
    ...
    nights_uncapped: 'Sem limite anual de noites',
  ...
  sv: {
    ...
    nights_uncapped: 'Ingen årlig gräns för nätter',
  ...
  da: {
    ...
    nights_uncapped: 'Ingen årlig grænse for nætter',
  ...
  no: {
    ...
    nights_uncapped: 'Ingen årlig grense for netter',
    nights_fraction: (n) => `Din 1/${n} av året`,
...
export default function PropertyPage({ property: p0, similar, showEnhancedSections = false, facts = null, forceLocale = null, hreflangLocales = null }) {
  ...
  const usageKind = facts && facts.usage ? facts.usage.kind : null;
  const usageText = (() => {
      ...
      <div className="pp-content" id="overview">
        <div className="pp-left">
          ...
          <div className="pp-stats">
            ...
            {usageText
              ? <div className="pp-stat"><span className="pp-stat-val pp-stat-val-sm">{usageText}</span><span className="pp-stat-lbl">{usageKind === 'uncapped' ? ft.time : t.per_year}</span></div>
              : null}
