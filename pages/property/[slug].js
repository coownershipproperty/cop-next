...
const COPY = {
  en: {
    ...
    coown_points: (n, days) => [
      ...
      ['Transfer to your loved ones', 'Pass your share on to your children or loved ones, so your family can enjoy the home for generations.'],
    ],
  ...
  es: {
    ...
    coown_points: (n, days) => [
      ...
      ['Transmite tu participación a tus seres queridos', 'Deja tu participación a tus hijos o seres queridos para que tu familia disfrute de la casa durante generaciones.'],
    ],
  ...
  fr: {
    ...
    coown_points: (n, days) => [
      ...
      ['Transmettez votre part à vos proches', 'Transmettez votre part à vos enfants ou à vos proches, pour que votre famille profite de la maison de génération en génération.'],
    ],
  ...
  de: {
    ...
    coown_points: (n, days) => [
      ...
      ['Geben Sie Ihren Anteil an Ihre Liebsten weiter', 'Übertragen Sie Ihren Anteil an Ihre Kinder oder andere Ihnen nahestehende Menschen, damit Ihre Familie das Zuhause über Generationen genießen kann.'],
    ],
  ...
  // Swedish, Danish and Norwegian. Until 22 Sep 2026 COPY stopped at pt and
  // these three fell through to COPY.en, so a Swedish reader on a Swedish URL
  // under a Swedish title read "Bedrooms", "Enquire About This Property" and
  // the whole co-ownership explainer in English. Terminology follows
  // docs/translation-glossary.md: samagande / medejerskab / sameie are the
  // locked primary terms, and bostadsratt, anpartslejlighed and borettslag
  // are never used — each names a different domestic tenure and would be
  // factually wrong.
  sv: {
    cobadge: (n) => `1/${n} samägande`,
    price_qualifier: (n) => `för en 1/${n}-andel`,
    bedrooms: 'Sovrum', bathrooms: 'Badrum', total_size: 'Boyta', per_year: 'Per år', share_size: 'Andelens storlek',
    about_heading: 'Om det här huset',
    desc_empty: 'Fler detaljer kommer snart. Använd formuläret så hör vi av oss.',
    show_less: 'Visa mindre', read_more: 'Läs mer',
    amenities_heading: 'Utrustning och bekvämligheter',
    all_amenities: (n) => `Alla ${n} bekvämligheter`,
    location_heading: 'Läge',
    similar_heading: (country) => `Liknande hem i ${country}`,
    pillar_link: (country) => `Se alla hem med samägande i ${country} →`,
    tab_overview: 'Översikt', tab_look: 'Se inuti', tab_amenities: 'Bekvämligheter', tab_location: 'Läge', tab_coown: 'Samägande', tab_fin: 'Finansiering',
    look_heading: 'Se inuti',
    look_sub: 'Bläddra i bildgalleriet, eller be oss om en komplett 3D-visning av huset.',
    look_gallery_btn: 'Visa bildgalleriet',
    ...
    coown_points: (n, days) => [
      ...
      ['Sälj när du vill', 'Din andel är en verklig tillgång: sälj den till det pris du själv sätter.'],
      ['Lämna över till dina närmaste', 'För din andel vidare till dina barn eller närmaste, så att familjen kan ha huset i generationer.'],
    ],
    missing_photos: (n) => `Du missar ${n} ${n === 1 ? 'bild' : 'bilder'}`,
    unlock_sub: 'Lås upp en gång — se alla gallerier på sajten',
    unlock_now: 'Lås upp nu',
    unlocked_title: 'Dina gallerier är upplåsta',
    unlocked_sub: (n) => n > 1 ? `Se alla ${n} bilder på det här huset`
    ...
    contact_sub: 'Fråga',
    eq_name: 'Ditt namn', eq_name_ph: 'För- och efternamn',
    eq_email: 'E-post', eq_email_ph: 'din@epost.se',
    eq_phone: 'Telefon', eq_phone_ph: '+46 eller +44…',
    eq_msg: 'Meddelande', eq_msg_ph: 'Frågor om det här huset…',
    eq_send: 'Skicka förfrågan →', eq_sending: 'Skickar…',
    eq_thanks: (n) => `Tack ${n}! Vi hör av oss inom kort.`,
    eq_err: 'Något gick fel. Försök igen.',
    eq_chips: (sym) => [
      { k: 'when', q: 'Hur ser din tidsplan ut?',
        o: ['Inom 3 månader', 'I år', 'Tittar bara'],
        v: ['3-months', 'this-year', 'browsing'] },
      { k: 'budget', q: 'Ungefär vilken nivå tänker du dig?',
        o: [`Under ${sym}200k`, `${sym}200–400k`, `${sym}400k+`, 'Säger hellre inte'],
        v: ['under-200k', '200-400k', '400k+', ''] },
      { k: 'seen', q: 'Har du tittat på samägande tidigare?',
        o: ['Första gången jag hör om det', 'Har tittat ett tag', 'Äger redan en andel'] },
    ],
    eq_chip_labels: { when: 'Tidsplan', budget: 'Budget', seen: 'Erfarenhet' },
    eq_note_add: 'Lägg till ett meddelande (valfritt)',
  },
  da: {
    cobadge: (n) => `1/${n} medejerskab`,
    price_qualifier: (n) => `for en 1/${n}-andel`,
    bedrooms: 'Soveværelser', bathrooms: 'Badeværelser', total_size: 'Boligareal', per_year: 'Pr. år', share_size: 'Andelens størrelse',
    about_heading: 'Om denne bolig',
    desc_empty: 'Flere detaljer følger snart. Brug formularen, så vender vi tilbage.',
    show_less: 'Vis mindre', read_more: 'Læs mere',
    amenities_heading: 'Faciliteter og udstyr',
    all_amenities: (n) => `Alle ${n} faciliteter`,
    location_heading: 'Beliggenhed',
    similar_heading: (country) => `Lignende boliger i ${country}`,
    pillar_link: (country) => `Se alle boliger med medejerskab i ${country} →`,
    tab_overview: 'Overblik', tab_look: 'Se indenfor', tab_amenities: 'Faciliteter', tab_location: 'Beliggenhed', tab_coown: 'Medejerskab', tab_fin: 'Finansiering',
    look_heading: 'Se indenfor',
    look_sub: 'Se billedgalleriet, eller bed os om en fuld 3D-rundvisning af boligen.',
    look_gallery_btn: 'Se billedgalleriet',
    ...
    coown_points: (n, days) => [
      ...
      ['Sælg når du vil', 'Din andel er et reelt aktiv: sælg den til den pris, du selv sætter.'],
      ['Giv den videre til dine nærmeste', 'Før din andel videre til dine børn eller nærmeste, så familien kan bruge boligen i generationer.'],
    ],
    missing_photos: (n) => `Du mangler ${n} ${n === 1 ? 'billede' : 'billeder'}`,
    unlock_sub: 'Lås op én gang — se alle gallerier på sitet',
    unlock_now: 'Lås op nu',
    unlocked_title: 'Dine gallerier er låst op',
    unlocked_sub: (n) => n > 1 ? `Se alle ${n} billeder af denne bolig`
    ...
    contact_cta: 'Kontakt os',
    contact_sub: 'Spørg',
    eq_name: 'Dit navn', eq_name_ph: 'Fulde navn',
    eq_email: 'E-mail', eq_email_ph: 'din@mail.dk',
    eq_phone: 'Telefon', eq_phone_ph: '+45 eller +44…',
    eq_msg: 'Besked', eq_msg_ph: 'Spørgsmål om denne bolig…',
    eq_send: 'Send forespørgsel →', eq_sending: 'Sender…',
    eq_thanks: (n) => `Tak ${n}! Vi vender tilbage hurtigst muligt.`,
    eq_err: 'Noget gik galt. Prøv igen.',
    eq_chips: (sym) => [
      { k: 'when', q: 'Hvad er din tidsplan?',
        o: ['Inden for 3 måneder', 'I år', 'Kigger bare'],
        v: ['3-months', 'this-year', 'browsing'] },
      { k: 'budget', q: 'Hvilket niveau tænker du cirka?',
        o: [`Under ${sym}200k`, `${sym}200–400k`, `${sym}400k+`, 'Siger hellere ikke'],
        v: ['under-200k', '200-400k', '400k+', ''] },
      { k: 'seen', q: 'Har du set på medejerskab før?',
        o: ['Første gang jeg hører om det', 'Har kigget et stykke tid', 'Ejer allerede en andel'] },
    ],
    eq_chip_labels: { when: 'Tidsplan', budget: 'Budget', seen: 'Erfaring' },
    eq_note_add: 'Tilføj en besked (valgfrit)',
  },
  no: {
    cobadge: (n) => `1/${n} sameie`,
    price_qualifier: (n) => `for en 1/${n}-andel`,
    bedrooms: 'Soverom', bathrooms: 'Bad', total_size: 'Boareal', per_year: 'Per år', share_size: 'Andelens størrelse',
    about_heading: 'Om denne boligen',
    desc_empty: 'Flere detaljer kommer snart. Bruk skjemaet, så tar vi kontakt.',
    show_less: 'Vis mindre', read_more: 'Les mer',
    amenities_heading: 'Fasiliteter og utstyr',
    all_amenities: (n) => `Alle ${n} fasiliteter`,
    location_heading: 'Beliggenhet',
    similar_heading: (country) => `Lignende boliger i ${country}`,
    pillar_link: (country) => `Se alle boliger i sameie i ${country} →`,
    tab_overview: 'Oversikt', tab_look: 'Se innvendig', tab_amenities: 'Fasiliteter', tab_location: 'Beliggenhet', tab_coown: 'Sameie', tab_fin: 'Finansiering',
    look_heading: 'Se innvendig',
    look_sub: 'Bla i bildegalleriet, eller be oss om en full 3D-visning av boligen.',
    look_gallery_btn: 'Se bildegalleriet',
    ...
    coown_points: (n, days) => [
      ...
      ['Selg når du vil', 'Andelen din er et reelt aktivum: selg den til prisen du selv setter.'],
      ['Før den videre til dine nærmeste', 'Før andelen videre til barna dine eller dine nærmeste, så familien kan bruke boligen i generasjoner.'],
    ],
    missing_photos: (n) => `Du går glipp av ${n} ${n === 1 ? 'bilde' : 'bilder'}`,
    unlock_sub: 'Lås opp én gang — se alle galleriene på nettstedet',
    unlock_now: 'Lås opp nå',
    unlocked_title: 'Galleriene dine er låst opp',
    unlocked_sub: (n) => n > 1 ? `Se alle ${n} bildene av denne boligen`
    ...
    contact_sub: 'Spør',
    eq_name: 'Navnet ditt', eq_name_ph: 'Fullt navn',
    eq_email: 'E-post', eq_email_ph: 'din@epost.no',
    eq_phone: 'Telefon', eq_phone_ph: '+47 eller +44…',
    eq_msg: 'Melding', eq_msg_ph: 'Spørsmål om denne boligen…',
    eq_send: 'Send forespørsel →', eq_sending: 'Sender…',
    eq_thanks: (n) => `Takk ${n}! Vi tar kontakt snart.`,
    eq_err: 'Noe gikk galt. Prøv igjen.',
    eq_chips: (sym) => [
      { k: 'when', q: 'Hva er tidsplanen din?',
        o: ['Innen 3 måneder', 'I år', 'Bare ser meg om'],
        v: ['3-months', 'this-year', 'browsing'] },
      { k: 'budget', q: 'Omtrent hvilket nivå tenker du?',
        o: [`Under ${sym}200k`, `${sym}200–400k`, `${sym}400k+`, 'Sier helst ikke'],
        v: ['under-200k', '200-400k', '400k+', ''] },
      { k: 'seen', q: 'Har du sett på sameie før?',
        o: ['Første gang jeg hører om det', 'Har sett på det en stund', 'Eier allerede en andel'] },
    ],
    eq_chip_labels: { when: 'Tidsplan', budget: 'Budsjett', seen: 'Erfaring' },
    eq_note_add: 'Legg til en melding (valgfritt)',
  },
};
