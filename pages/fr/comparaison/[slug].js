/**
 * pages/fr/comparaison/[slug].js — French comparison pages
 * URL pattern: /fr/comparaison/{slug}/
 */
...
const LOCALE = 'fr';
const META_FILE = 'compare-meta-fr.json';
const CONTENT_DIR = 'content/compare/fr';
...
export default function FrComparePage(props) {
