    ...
    <>
      ...
      <section className="sec faq-sec">
        ...
        <ul className="faq-list">
          ...
          <li className="faq-item"><details><summary><h3>Comment est-ce structuré juridiquement ?</h3><div className="faq-chevron"></div></summary><div className="faq-answer"><p>Le modèle professionnel standard utilise une SL espagnole (Sociedad Limitada) dont l'unique actif est le bien. Vous achetez des parts de cette SL devant notaire, ce qui vous confère la propriété légale de votre quote-part. La SL est inscrite comme propriétaire au Registre de la Propriété de Mallorque. Les statuts fixent le calendrier d'usage, les frais et les règles de revente.</p></div></details></li>
