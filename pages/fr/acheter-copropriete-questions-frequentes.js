...
// avec la multipropriété/timeshare/temps partagé dans la Q2, sans
// positionner notre produit comme tel ailleurs dans le contenu.

const FAQS = [
  {
    q: 'Qu\'est-ce qu\'une propriété en copropriété, et comment fonctionne la propriété fractionnée ?',
    a: `Une propriété en copropriété — aussi appelée propriété fractionnée — est une résidence secondaire de luxe acquise conjointement par un petit groupe de propriétaires, typiquement jusqu'à huit, via une société. Cette société détient 100 % du titre de propriété : en France une SCI (Société Civile Immobilière), en Espagne une SL (Sociedad Limitada), au Royaume-Uni ou aux États-Unis une Limited Company ou LLC. Chaque acheteur acquiert par acte authentique une part de cette société — et, par extension, une véritable propriété sur le bien immobilier lui-même. À la différence d'une multipropriété ou d'un timeshare, votre nom (ou celui de votre société) figure sur le titre de propriété, vous bénéficiez de toute appréciation de valeur, et vous pouvez vendre votre part sur le marché ouvert quand vous le souhaitez. Une société professionnelle de gestion s'occupe de toutes les opérations quotidiennes — entretien, ménage, piscine, jardin et, le cas échéant, la location des semaines non utilisées — pour que vous arriviez, profitiez, et repartiez.`,
  },
  {
    q: 'En quoi la copropriété diffère-t-elle du timeshare ou de la multipropriété ? Pourquoi est-ce une meilleure option ?',
    a: `La différence est fondamentale. Un timeshare ou une multipropriété (en France régie par le régime de la jouissance d'immeubles à temps partagé) vous donne uniquement le droit d'utiliser un bien pendant une période fixe chaque année — vous achetez du temps, pas de l'immobilier. Votre nom ne figure sur aucun titre de propriété, l'actif ne prend pas de valeur, et vous êtes enfermé dans un système d'adhésion ou de points notoirement difficile à quitter. La copropriété vous donne un actif immobilier véritable, acté. Vous êtes propriétaire d'une fraction d'une vraie résidence via une structure sociétaire. Votre nom (ou celui de votre société) figure sur le titre. Vous participez à toute appréciation du capital. Vous pouvez vendre, donner ou transmettre votre part à votre famille avec une complexité juridique minimale. Vous profitez de la propriété avec souplesse — à partir de deux ou trois nuits seulement — au lieu d'une semaine fixe chaque année. Et une équipe professionnelle de conciergerie et de gestion s'occupe de tout, y compris l'option de générer des revenus locatifs durant les semaines que vous n'utilisez pas.`,
  },
  {
    q: 'Combien de parts puis-je acheter, et combien de jours chaque part me donne-t-elle ?',
    a: `La plupart des propriétés sont structurées en huit parts égales, chaque part de 1/8 donnant droit à environ 42 à 45 jours d'usage privé par an — soit environ six semaines. Vous pouvez généralement acquérir entre une et quatre parts d'une même propriété (jusqu'à 50 %), ce qui vous permet de cumuler 44, 88, 132 ou jusqu'à 176 jours par an. On évite qu'un titulaire dépasse 50 % afin qu'aucun copropriétaire ne puisse dominer les décisions de la société. Si vous souhaitez disposer de plus de temps au total, vous pouvez acquérir des parts dans plusieurs propriétés réparties sur différentes destinations. L'usage est généralement géré via un calendrier rotatif ou une plateforme numérique de réservation qui garantit à tous les copropriétaires un accès équitable aux dates de haute saison dans le temps.`,
  },
  {
    q: 'Qu\'est-ce qui est inclus dans le prix d\'achat d\'une part en copropriété fractionnée ?',
    a: `Le prix d'une part en copropriété est pleinement tout compris. Il couvre votre titre de propriété acté, les droits de mutation et frais de transfert, le coût intégral de l'acquisition du bien, les travaux de rénovation et d'aménagement, le design d'intérieur professionnel, le mobilier et l'équipement, ainsi que la constitution juridique de la société propriétaire. Il n'y a pas d'extras cachés ni de surprises juridiques à la signature. Les coûts récurrents — gestion annuelle de la propriété, entretien, assurances, impôts locaux et charges — sont répartis proportionnellement entre tous les copropriétaires, gardant vos dépenses annuelles très faibles par rapport à la propriété entière d'un bien équivalent.`,
  },
  {
  ...
  },
  {
    ...
    a: `Absolument. Il n'y a pas de restrictions de nationalité pour l'acquisition immobilière en France, Espagne, Italie, Portugal ou aux États-Unis — et la copropriété fonctionne via les mêmes structures sociétaires accessibles aux résidents comme aux non-résidents. En France, les parts sont détenues via une SCI ; en Espagne via une SL ; aux États-Unis via une LLC. Un avantage fiscal clé pour les non-résidents qui achètent en France : l'Impôt sur la Fortune Immobilière (IFI) ne s'applique que si la valeur nette de vos actifs immobiliers français dépasse 1,3 million d'euros. Comme vous détenez une fraction du bien plutôt que la totalité, vous pourriez être copropriétaire d'une villa à 5 millions d'euros tout en restant sous ce seuil — sans payer d'IFI français du tout.`,
  },
  {
  ...
  {
    q: 'Puis-je amener mon propre groupe pour partager une propriété ?',
  ...
  {
    q: 'Si je trouve une propriété qui me plaît, pouvez-vous m\'aider à trouver des co-acquéreurs pour les parts restantes ?',
    a: `Oui. Si vous identifiez une propriété que vous souhaitez partager mais qu'il vous manque des acheteurs pour les parts restantes, nous pouvons les chercher dans notre réseau d'acquéreurs qualifiés. Nous vous demandons de vous engager sur un minimum de 50 % des parts totales en amont. Important : vous n'avez pas à attendre que toutes les parts soient vendues pour commencer à utiliser la propriété — votre droit d'usage commence dès que votre part est constituée. Cela signifie que vous pouvez commencer à profiter de la maison pendant que les parts restantes sont placées auprès de copropriétaires vérifiés, plutôt que de rester sur la touche.`,
  },
  {
    q: 'Combien de temps après l\'achat puis-je commencer à utiliser la propriété ?',
    a: `Pour les propriétés où la société est déjà constituée et la résidence prête à l'usage, vous pouvez généralement commencer à réserver dans les jours qui suivent la finalisation de l'achat — avec les premiers séjours possibles en quelques semaines. Si la propriété est encore en rénovation ou en cours d'aménagement intérieur au moment de l'achat, il y aura une période d'achèvement avant qu'elle ne soit prête. Dans tous les cas, le délai est considérablement plus rapide que l'achat d'un bien traditionnel, où les procédures, les rénovations et l'ameublement prennent typiquement six mois à plus d'un an avant que vous ne puissiez réellement profiter de la résidence.`,
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Tout ce qu'il faut savoir pour acheter une propriété en copropriété — structure juridique, coûts, prêts, et fonctionnement du processus d'achat de la réservation à la signature." />
        ...
        <meta property="og:description" content="Structure juridique, coûts, prêts et processus d'achat d'une propriété en copropriété." />
      ...
      <section className="sec" style={{ background: 'var(--cream-bg)', paddingTop: 60, paddingBottom: 80 }}>
        <div className="sec-inner" style={{ maxWidth: 760 }}>
          ...
          <div className="bfaq-links">
            <a href="/our-homes/" className="bfaq-link">Voir toutes les propriétés →</a>
