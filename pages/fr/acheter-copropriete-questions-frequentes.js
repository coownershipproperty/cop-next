...
const FAQS = [
  {
    ...
    a: `Une propriété en copropriété — aussi appelée propriété fractionnée — est une résidence secondaire de luxe acquise conjointement par un petit groupe de propriétaires, typiquement jusqu'à huit, via une LLC (Limited Liability Company) constituée spécifiquement pour ce bien. Cette LLC détient 100 % du titre de propriété, et la même structure est utilisée de manière homogène à travers tout le portefeuille international — France, Espagne, Italie, Portugal et États-Unis. Chaque acheteur acquiert par acte authentique un membership interest dans cette LLC — et, par extension, une véritable propriété sur le bien immobilier lui-même. À la différence d'une multipropriété ou d'un timeshare, votre nom (ou celui de votre société) figure derrière le titre de propriété, vous bénéficiez de toute appréciation de valeur, et vous pouvez vendre votre part sur le marché ouvert quand vous le souhaitez. Une société professionnelle de gestion s'occupe de toutes les opérations quotidiennes — entretien, ménage, piscine, jardin et, le cas échéant, la location des semaines non utilisées — pour que vous arriviez, profitiez, et repartiez.`,
  },
  {
