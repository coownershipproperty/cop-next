  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Tout ce qu'il faut savoir pour profiter de votre propriété en copropriété — réservations, arrivée, invités, planification saisonnière, revenus locatifs et règlement intérieur." />
      ...
      <section className="page-hero">
        ...
        <p className="subtitle">Tout ce qu'il faut savoir pour réserver votre temps, arriver, recevoir des invités et tirer le meilleur parti de votre propriété en copropriété.</p>
      </section>
