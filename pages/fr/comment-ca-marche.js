    ...
    <>
        ...
        <div className="sec-inner">
          <div className="intro-grid">
            ...
            <div className="intro-text">
              ...
              <p className="highlight">Une maison de vacances de luxe qui coûterait des millions à acquérir seul devient vôtre pour une fraction — avec les mêmes droits, le même acte notarial et la même valorisation future.</p>
              <p>Avec la copropriété, vous achetez une <strong>part enregistrée</strong> — typiquement 1/8 — d'un bien premium. Elle est inscrite à votre nom via une société de type SCI propre au bien — une structure utilisée de manière homogène à travers toute notre offre. Vous utilisez votre bien environ 45 jours par an (1/8), et tous les coûts sont partagés au prorata entre copropriétaires.</p>
              <p>Ce n'est pas du « temps partagé ». Pas de « club de propriétaires », pas de piège. C'est une véritable résidence secondaire — un bien que vous pouvez revendre, transmettre à vos enfants, ou tout simplement regarder prendre de la valeur.</p>
        ...
        <div className="sec-inner" style={{textAlign: 'center'}}>
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <h3>Vrai bien immobilier</h3>
              <p>Une part enregistrée à votre nom via une SCI possédant la totalité du bien. Pas un bout de papier — un véritable actif que vous possédez, régularisé chez le notaire.</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">&#x1f4c8;</div>
              <h3>Plus-value</h3>
            ...
            <div className="benefit-card">
              ...
              <p>Vous n'utilisez pas vos semaines allouées ? De nombreux biens vous permettent de louer vos semaines inutilisées — contactez-nous pour plus d'infos.</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">&#x1f504;</div>
              <h3>Échange de biens entre copropriétaires</h3>
              <p>La plupart de notre offre propose un système d'échange. Envie d'une autre destination cette année ? Échangez votre séjour avec un autre copropriétaire.</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">&#x1f5d3;</div>
      ...
      <section className="sec model-sec">
        <div className="sec-inner" style={{textAlign: 'center'}}>
          ...
          <p className="lead" style={{margin: '0 auto'}}>Chaque bien est détenu dans sa propre SCI. Vous achetez une quote-part dans cette SCI — vous donnant un bien authentique et enregistré avec une protection juridique complète.</p>

          <div className="model-flow">
            <div className="model-step">
              <div className="model-num">1</div>
              <h3>Parcourez et choisissez</h3>
              <p>Explorez plus de 360 biens de luxe sélectionnés. Filtrez par destination, style de vie, budget et taille de quote-part.</p>
            </div>
            <div className="model-step">
              <div className="model-num">2</div>
              <h3>Tout l'aspect juridique est géré</h3>
            ...
            <div className="model-step">
              ...
              <h3>Achetez votre part ou vos parts</h3>
              <p>Signez l'acte authentique chez le notaire, votre quote-part est enregistrée chez le notaire (comme dans toute SCI), et vous recevez votre acte notarial. La plupart des maisons sont prêtes à habiter.</p>
            </div>
            <div className="model-step">
      ...
      <section className="sec faq-sec">
        ...
        <ul className="faq-list">
          ...
          <li className="faq-item"><details><summary><h3>Puis-je générer des revenus locatifs ?</h3><div className="faq-chevron"></div></summary><div className="faq-answer"><p>Sur de nombreux biens, oui. Si vous n'utilisez pas vos semaines allouées, vous pouvez les louer et générer des revenus. L'équipe de gestion peut s'occuper du processus de location pour vous. La disponibilité varie selon le bien — demandez-nous les détails sur des annonces spécifiques.</p></div></details></li>
          <li className="faq-item"><details><summary><h3>Et l'échange de maisons ?</h3><div className="faq-chevron"></div></summary><div className="faq-answer"><p>La plupart des biens de notre portefeuille offrent un système d'échange. Si vous souhaitez passer votre temps alloué dans une autre destination, vous pouvez organiser un échange avec un copropriétaire d'un autre bien. C'est un excellent moyen d'explorer différents endroits sans coût supplémentaire.</p></div></details></li>
          <li className="faq-item"><details><summary><h3>Quels coûts sont partagés ?</h3><div className="faq-chevron"></div></summary><div className="faq-answer"><p>Tous les frais courants sont divisés au prorata : taxe foncière, assurance, charges, entretien, réparations, ménage et gestion professionnelle. Un règlement de copropriété précise exactement comment les frais sont gérés. De nombreux biens sont entièrement meublés et rénovés, avec ces coûts inclus dans le prix de la quote-part.</p></div></details></li>
