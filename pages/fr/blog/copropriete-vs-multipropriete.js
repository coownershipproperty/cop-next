    ...
    <>
      <Head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@type': 'FAQPage',
          mainEntity: [
            { '@type': 'Question', name: 'Quelle est la différence entre copropriété et multibien ?', acceptedAnswer: { '@type': 'Answer', text: "La copropriété de résidence secondaire est une vrai bien immobilière : vous êtes copropriétaire enregistré d'une fraction du bien (typiquement 1/8) via une LLC (Limited Liability Company) qui détient le bien, avec acte authentique chez le notaire et inscription au cadastre. La multibien (ou temps partagé) est seulement un droit d'usage de semaines déterminées — vous n'êtes pas propriétaire du bien, il ne prend pas de valeur, et la revente est notoirement difficile." } },
            ...
            { '@type': 'Question', name: 'Comment distinguer une multibien déguisée en copropriété ?', acceptedAnswer: { '@type': 'Answer', text: "Demandez toujours trois choses : (1) l'acte authentique chez le notaire qui vous rendra membre d'une LLC propriétaire du bien ; (2) l'inscription de la LLC au cadastre comme propriétaire ; (3) l'operating agreement de la LLC précisant votre droit d'usage. Si on vous propose un 'club', des 'points', ou des 'droits d'usage' sans bien enregistré, c'est de la multibien — quel que soit le nom commercial." } },
          ],
        }) }} />
      </Head>
      <Header />
      ...
      <div className="blog-layout">
        <main className="blog-main">
          <article className="blog-article">
            ...
            <p style={{fontSize:'1.18rem', borderLeft:'4px solid #6b6b6b', paddingLeft:'1.25rem', margin:'2rem 0', color:'#2C4A5E'}}>La <strong>copropriété de résidence secondaire</strong> fait de vous le copropriétaire réel d'une fraction du bien, enregistrée au cadastre. La <strong>multibien</strong> vous donne seulement le droit d'utiliser le bien pendant des semaines déterminées — vous n'êtes pas propriétaire du bien.</p>
            ...
            <table className="cop-pillar-table">
              ...
              <tbody>
                <tr><td>Régime juridique</td><td>Bien immobilière (LLC propriétaire)</td><td>Droit d'usage à temps partagé (Code consommation)</td></tr>
            ...
            <p>Résultat : vous êtes véritable copropriétaire (via la LLC) d'une fraction du bien, votre bien est protégé juridiquement, et l'inscription au cadastre fait foi. La LLC offre également une protection de la responsabilité personnelle et une cohérence d'un pays à l'autre — un atout majeur pour qui détient des biens dans plusieurs juridictions.</p>
            ...
            <p style={{marginTop:'3rem'}}><strong>Si vous voulez explorer des options de copropriété en Europe</strong>, nous présentons les biens des principaux opérateurs en Espagne (Mallorque, Ibiza, Costa del Sol), en France (Provence, Côte d'Azur, Alpes), en Italie et au-delà — toutes avec acte authentique chez le notaire et inscription au cadastre.</p>
