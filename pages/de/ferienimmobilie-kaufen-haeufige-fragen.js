...
const FAQS = [
  {
    ...
    a: `Eine Co-Ownership-Ferienimmobilie — auch Miteigentum oder Anteilskauf-Immobilie genannt — ist eine luxuriöse Ferienimmobilie, die gemeinsam von einer kleinen Gruppe von Käufern erworben wird, typischerweise bis zu acht, über eine eigens gegründete LLC (Limited Liability Company). Diese LLC hält 100% des Grundbucheintrags, und dieselbe Struktur wird einheitlich über das gesamte globale Portfolio hinweg verwendet — in Frankreich, Spanien, Italien, Portugal und den USA gleichermaßen. Jeder Käufer erwirbt einen rechtlich verbrieften Mitgliedschaftsanteil (membership interest) an dieser LLC — und damit eine echte Eigentumsbeteiligung an der Immobilie selbst. Anders als beim Timesharing steht Ihr Name (oder der Ihrer Gesellschaft) hinter dem Grundbucheintrag, Sie profitieren von jeglicher Wertsteigerung und können Ihren Anteil jederzeit auf dem freien Markt verkaufen. Eine professionelle Verwaltungsgesellschaft kümmert sich um sämtliche operativen Aufgaben — Wartung, Reinigung, Poolservice und Mieteinnahmen, wenn die Immobilie nicht genutzt wird — sodass Sie einfach ankommen, genießen und wieder abreisen.`,
  },
  {
