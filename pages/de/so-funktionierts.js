...
{/* ===== HERO ===== */}
    ...
    <section className="sec faq-sec">
        ...
        <ul className="faq-list">
            ...
            <li className="faq-item"><details><summary><h3>Was ist die Holdinggesellschaft-Struktur?</h3><div className="faq-chevron"></div></summary><div className="faq-answer"><p>Jede Immobilie wird in einer eigenen Holdinggesellschaft gehalten (meist eine spanische SL, italienische Srl, portugiesische Lda oder vergleichbare Gesellschaft im Land der Immobilie). Wenn Sie einen Anteil kaufen, erwerben Sie Geschäftsanteile an dieser Gesellschaft — und erhalten so Eigentum an der Immobilie, anteilig zu Ihrer Anteilsgröße. Diese Struktur bietet Haftungsschutz, vereinfacht den Wiederverkauf und sorgt für eine saubere rechtliche Trennung zwischen den Miteigentümern.</p></div></details></li>
