...
export async function getStaticProps({ params }) {
  ...
  body = fillInventoryDeep(injectH2Ids(body), inv, { locale: 'de' });
  const filledEntry = fillInventoryDeep(entry, inv, { locale: 'de' });
  const inventory = inventorySummary(inv, { partner: slug, locale: 'de' });
