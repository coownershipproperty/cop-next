/**
 * pages/compare/[slug].js — English comparison pages
 *
 * Thin wrapper around components/ComparePageRenderer. Reads English content
 * from content/compare/{slug}.html and metadata from lib/compare-meta.json,
 * then delegates rendering. Locale-specific siblings live at
 * pages/{es,fr,de}/{comparativa,comparaison,vergleich}/[slug].js.
 */
...
const LOCALE = 'en';
const META_FILE = 'compare-meta.json';
const CONTENT_DIR = 'content/compare';
...
export default function EnComparePage(props) {
