// PT mirror of the programmatic town landing pages.
// Re-uses getStaticPaths / getStaticProps and the component from
// /pages/co-ownership/[town].js, forcing locale='pt' so the page is pt from
...
// translated into pt yet, so a PT URL never serves an English body. New
...
export async function getStaticProps(ctx) {
  return gateOnTranslation(await baseGetStaticProps(ctx), 'pt');
}

export default function TownPage_pt(props) {
  return <TownPage {...props} forceLocale="pt" />;
}
