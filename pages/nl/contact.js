// /nl/ — contact page. The same component the English contact page renders,
// with this locale's copy from content/contact/nl.json.
...
export default function ContactNL(props) {
  return <ContactView locale="nl" {...props} />;
}
