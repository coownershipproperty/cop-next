    ...
    <>
      ...
      <section className="sec faq-sec">
        ...
        <ul className="faq-list">
          ...
          <li className="faq-item"><details><summary><h3>¿Qué es la estructura SL?</h3><div className="faq-chevron"></div></summary><div className="faq-answer"><p>Cada propiedad se mantiene en su propia SL (Sociedad Limitada) dedicada. Cuando compras una fracción, adquieres participaciones de esa SL — lo que te otorga propiedad legal de la propiedad proporcional al tamaño de tu fracción. Esta estructura proporciona protección de responsabilidad, simplifica la reventa y garantiza una clara separación legal entre los copropietarios.</p></div></details></li>
