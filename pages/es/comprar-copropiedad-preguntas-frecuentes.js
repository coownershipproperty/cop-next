...
const FAQS = [
  {
    ...
    a: `Una propiedad en copropiedad — también llamada propiedad fraccional — es una segunda residencia de lujo adquirida conjuntamente por un grupo pequeño de propietarios, normalmente hasta ocho, a través de una sociedad limitada. Esa sociedad es titular del 100 % del inmueble en el Registro de la Propiedad: en España una SL (Sociedad Limitada), en Francia una SCI (Société Civile Immobilière), en Reino Unido o Estados Unidos una Limited Company o LLC. Cada comprador adquiere mediante escritura una participación de esa sociedad — y, por extensión, una titularidad real sobre el propio inmueble. A diferencia de la multipropiedad o timeshare, su nombre (o el de su sociedad) figura en la titularidad registral, usted se beneficia de la revalorización y puede vender su participación en el mercado abierto cuando lo desee. Una empresa profesional de gestión se ocupa de todas las operaciones del día a día — mantenimiento, limpieza, piscina, jardín y, en su caso, el alquiler de las semanas no utilizadas — para que usted simplemente llegue, disfrute y se vaya.`,
  },
  {
  ...
  },
  {
    ...
    a: `Por supuesto. No hay restricciones por nacionalidad para adquirir inmuebles en España, Francia, Italia, Portugal o Estados Unidos — y la copropiedad funciona a través de las mismas estructuras societarias disponibles tanto para residentes como no residentes. En España, las participaciones se mantienen a través de una SL; en Francia, a través de una SCI; en Estados Unidos, a través de una LLC. Una ventaja fiscal importante para no residentes que compran en Francia es que el impuesto sobre patrimonio inmobiliario (IFI) solo se aplica si el valor neto de sus activos inmobiliarios en Francia supera los 1,3 millones de euros. Como usted es titular de una fracción del inmueble y no de la totalidad, podría ser copropietario de una villa de 5 millones y mantenerse por debajo del umbral — sin pagar IFI alguno.`,
  },
  {
