...
export async function getStaticProps() {
  ...
  const properties = (data || []).map(p => ({
    ...
    totalImages: p.is_discreet ? 1 : (p.total_images || 0), hasGallery: !p.is_discreet && !!p.drive_url, discreet: !!p.is_discreet,
    ...
    <div className="rd rd-destination">
      ...
      <section className="sec faq-sec">
        ...
        <ul className="faq-list">
          ...
          <li className="faq-item"><details><summary><h3>¿Cómo se estructura legalmente?</h3><div className="faq-chevron"></div></summary><div className="faq-answer"><p>El modelo profesional utiliza una LLC (Limited Liability Company) constituida específicamente para el inmueble — la misma estructura utilizada de forma homogénea en toda nuestra cartera internacional. Compras un membership interest en esa LLC ante notario, lo que te otorga propiedad legal de tu fracción. La LLC es titular registral del inmueble en el Registro de la Propiedad de Mallorca. El operating agreement fija el calendario de uso, gastos y derechos de reventa.</p></div></details></li>
