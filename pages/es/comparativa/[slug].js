/**
 * pages/es/comparativa/[slug].js — Spanish comparison pages
 * URL pattern: /es/comparativa/{slug}/
 */
...
const LOCALE = 'es';
const META_FILE = 'compare-meta-es.json';
const CONTENT_DIR = 'content/compare/es';
...
export default function EsComparePage(props) {
