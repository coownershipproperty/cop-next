...
const HOMEPAGE_FAQS = [
  ...
  { q: "How is usage time divided between owners?", a: "Every one-eighth share gives you around six weeks a year — one-eighth of the calendar. Each property has a clear usage schedule that rotates fairly so all owners enjoy peak-season access over time. Many operators also offer a digital booking platform so you can swap, extend, or exchange weeks with fellow owners flexibly." },
    ...
    <section className="faq-section" id="faq">
        ...
        <div className="faq-list">
            ...
            <details className="faq-item">
                ...
                <div className="faq-a"><p>Every one-eighth share gives you around six weeks a year — one-eighth of the calendar. Each property has a clear usage schedule that rotates fairly so all owners enjoy peak-season access over time. Many operators also offer a digital booking platform so you can swap, extend, or exchange weeks with fellow owners flexibly.</p></div>
            </details>
