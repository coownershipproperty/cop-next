...
export default function NewListingsDigest({
  ...
  return (
    <Html lang="en" dir="ltr">
      ...
      <Body className="dm-page" style={body}>
              ...
              <Section key={i} style={card}>
                <table width="100%" cellPadding="0" cellSpacing="0" border={0} role="presentation">
                  <tbody><tr>
                    ...
                    >
                      <Link href={`${base}/property/${p.slug}`} style={{ color: 'inherit', display: 'block', height: '340px', textDecoration: 'none' }}>
                        {p.isNew && (
                ...
                <table width="100%" cellPadding="0" cellSpacing="0" border={0} role="presentation" style={{ position: 'relative' as const, zIndex: 3 }}>
                  <tbody><tr><td style={cardInner} className="card-inner">
                    <Hr className="dm-rule" style={cardGoldRule} />
        ...
        <Section style={{ backgroundColor: C.cream, paddingBottom: 56 }}>
          <Container style={wrap}>
            ...
            <Hr className="dm-rule" style={goldRule} />
...
const newBadge: React.CSSProperties = { fontFamily: "'Inter','Helvetica Neue',Helvetica,Arial,sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: '0.18em', color: C.onDark, backgroundColor: C.gold, padding: '4px 10px', margin: 0, display: 'inline-block' };
...
const cardTitle: React.CSSProperties = { fontFamily: "'Poppins','Inter','Helvetica Neue',Helvetica,Arial,sans-serif", fontSize: 22, fontWeight: 400, color: C.navy, margin: '0 0 8px', lineHeight: '1.35', letterSpacing: '-0.02em' };
const cardBeds: React.CSSProperties = { fontFamily: "'Inter','Helvetica Neue',Helvetica,Arial,sans-serif", fontSize: 12, color: C.navy60, letterSpacing: '0.16em', textTransform: 'uppercase' as const, margin: 0 };
...
const viewBtn: React.CSSProperties = { fontFamily: "'Inter','Helvetica Neue',Helvetica,Arial,sans-serif", fontSize: 11, fontWeight: 600, letterSpacing: '0.16em', textTransform: 'uppercase' as const, backgroundColor: C.navy, color: C.onDark, textDecoration: 'none', padding: '13px 22px', display: 'block', textAlign: 'center' as const, whiteSpace: 'nowrap' as const };
...
const interestedBtn: React.CSSProperties = { fontFamily: "'Inter','Helvetica Neue',Helvetica,Arial,sans-serif", backgroundColor: C.gold, color: C.white, fontSize: 11, fontWeight: 600, letterSpacing: '0.16em', textTransform: 'uppercase' as const, textDecoration: 'none', padding: '13px 22px', display: 'block', textAlign: 'center' as const, whiteSpace: 'nowrap' as const };
