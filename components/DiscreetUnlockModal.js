...
export const DISCREET_COPY = {
  en: {
    ...
    sub: "This home is marketed discreetly. Send an enquiry and we'll open the full listing for you — every photo, floor plans, amenities and the complete description — and Dylan will follow up personally.",
    ...
    success_msg: 'Opening the full listing… Dylan will also be in touch personally about',
  ...
  es: {
    ...
    sub: 'Esta vivienda se comercializa de forma discreta. Envíanos tu consulta y te abriremos la ficha completa — todas las fotos, planos, equipamiento y la descripción íntegra — y Dylan te contactará personalmente.',
    ...
    success_msg: 'Abriendo la ficha completa… Dylan también se pondrá en contacto contigo personalmente sobre',
  ...
  fr: {
    ...
    sub: "Ce bien est commercialisé en toute discrétion. Envoyez votre demande et nous vous ouvrirons l'annonce complète — toutes les photos, les plans, les équipements et la description intégrale — et Dylan vous recontactera personnellement.",
    ...
    success_msg: "Ouverture de l'annonce complète… Dylan vous contactera également personnellement au sujet de",
  ...
  de: {
    ...
    sub: 'Dieses Objekt wird diskret vermarktet. Senden Sie Ihre Anfrage und wir schalten das vollständige Exposé für Sie frei — alle Fotos, Grundrisse, Ausstattung und die komplette Beschreibung — und Dylan meldet sich persönlich bei Ihnen.',
    ...
    success_msg: 'Das vollständige Exposé wird geöffnet… Dylan meldet sich außerdem persönlich bei Ihnen zu',
  ...
  it: {
    ...
    sub: 'Questa casa è commercializzata con discrezione. Invia la tua richiesta e ti apriremo la scheda completa — tutte le foto, le planimetrie, i servizi e la descrizione integrale — e Dylan ti contatterà personalmente.',
    ...
    success_msg: 'Apertura della scheda completa… Dylan ti contatterà anche personalmente riguardo a',
  ...
  nl: {
    ...
    sub: "Deze woning wordt discreet aangeboden. Stuur uw aanvraag en wij openen de volledige pagina voor u — alle foto's, plattegronden, voorzieningen en de complete beschrijving — en Dylan neemt persoonlijk contact met u op.",
    ...
    success_msg: 'De volledige pagina wordt geopend… Dylan neemt ook persoonlijk contact met u op over',
  ...
  pt: {
    ...
    sub: 'Esta casa é comercializada de forma discreta. Envie o seu pedido e abrimos-lhe a ficha completa — todas as fotos, plantas, comodidades e a descrição integral — e o Dylan entrará em contacto pessoalmente.',
    ...
    success_heading: 'Desbloqueada',
    success_msg: 'A abrir a ficha completa… O Dylan também entrará em contacto pessoalmente sobre',
  ...
  sv: {
    ...
    sub: 'Det här hemmet marknadsförs diskret. Skicka din förfrågan så öppnar vi hela beskrivningen för dig — alla foton, planritningar, bekvämligheter och den fullständiga texten — och Dylan hör av sig personligen.',
    ...
    success_msg: 'Öppnar hela beskrivningen… Dylan hör också av sig personligen om',
  ...
  da: {
    ...
    sub: 'Denne bolig markedsføres diskret. Send din forespørgsel, så åbner vi den fulde præsentation for dig — alle fotos, plantegninger, faciliteter og den komplette beskrivelse — og Dylan kontakter dig personligt.',
    ...
    success_msg: 'Åbner den fulde præsentation… Dylan kontakter dig også personligt om',
  ...
  no: {
    ...
    sub: 'Denne boligen markedsføres diskret. Send forespørselen din, så åpner vi hele presentasjonen for deg — alle bilder, plantegninger, fasiliteter og den komplette beskrivelsen — og Dylan tar personlig kontakt.',
    ...
    success_msg: 'Åpner hele presentasjonen… Dylan tar også personlig kontakt om',
