...
const COPY = {
  ...
  it: {
    ...
    heading: 'Scopri prima le nuove case',
    sub: 'Quasi ogni settimana arrivano nuove case in comproprietà e le quote migliori vanno subito. Lasciaci i tuoi dati e ti scriviamo appena esce qualcosa di nuovo.',
    email_placeholder: 'Il tuo indirizzo email',
    phone_placeholder: 'Numero di telefono (facoltativo)',
    btn_idle: 'Tienimi aggiornato →',
    btn_sending: 'Invio in corso…',
    success_heading: 'Sei nella lista',
    success_msg: 'Ti scriviamo appena viene pubblicata una nuova casa.',
    error: 'Qualcosa è andato storto. Riprova.',
    close: 'Chiudi',
    no_spam: 'Niente spam. Cancellazione in un clic, quando vuoi.',
  },
  nl: {
    eyebrow: 'Voordat u gaat',
    heading: 'Nieuwe woningen als eerste zien',
    sub: 'Bijna elke week komen er nieuwe woningen in mede-eigendom bij, en de mooiste aandelen zijn snel weg. Laat uw gegevens achter en wij mailen u zodra er iets nieuws is.',
    email_placeholder: 'Uw e-mailadres',
    phone_placeholder: 'Telefoonnummer (optioneel)',
    btn_idle: 'Houd mij op de hoogte →',
    btn_sending: 'Verzenden…',
    success_heading: 'U staat op de lijst',
    success_msg: 'Wij nemen contact op zodra er iets nieuws wordt aangeboden.',
    error: 'Er is iets misgegaan. Probeer het opnieuw.',
    close: 'Sluiten',
    no_spam: 'Geen spam. Afmelden kan altijd met één klik.',
  },
  pt: {
    eyebrow: 'Antes de você sair',
    heading: 'Veja os novos imóveis primeiro',
    sub: 'Novos imóveis em multipropriedade entram no site quase toda semana e as melhores cotas saem rápido. Deixe seus dados e avisamos por e-mail assim que surgir uma novidade.',
    email_placeholder: 'Seu e-mail',
    phone_placeholder: 'Telefone (opcional)',
    btn_idle: 'Quero ser avisado →',
    btn_sending: 'Enviando…',
    success_heading: 'Você está na lista',
    success_msg: 'Entraremos em contato assim que algo novo for anunciado.',
    error: 'Algo deu errado. Tente novamente.',
    close: 'Fechar',
    no_spam: 'Sem spam. Cancele quando quiser, com um clique.',
  },
  sv: {
    eyebrow: 'Innan du går',
    heading: 'Se nya bostäder först',
    sub: 'Nya bostäder i samägande läggs ut nästan varje vecka och de bästa andelarna går snabbt. Lämna dina uppgifter så hör vi av oss så fort något nytt dyker upp.',
    email_placeholder: 'Din e-postadress',
    phone_placeholder: 'Telefonnummer (valfritt)',
    btn_idle: 'Håll mig uppdaterad →',
    btn_sending: 'Skickar…',
    success_heading: 'Du står på listan',
    success_msg: 'Vi hör av oss så snart något nytt läggs ut.',
    error: 'Något gick fel. Försök igen.',
    close: 'Stäng',
    no_spam: 'Inget spam. Avregistrera dig när som helst med ett klick.',
  },
  da: {
    eyebrow: 'Før du går',
    heading: 'Se nye boliger først',
    sub: 'Der kommer nye boliger til medejerskab til næsten hver uge, og de bedste andele går hurtigt. Efterlad dine oplysninger, så skriver vi til dig, så snart der dukker noget nyt op.',
    email_placeholder: 'Din e-mailadresse',
    phone_placeholder: 'Telefonnummer (valgfrit)',
    btn_idle: 'Hold mig opdateret →',
    btn_sending: 'Sender…',
    success_heading: 'Du er på listen',
    success_msg: 'Vi kontakter dig, så snart der kommer noget nyt til salg.',
    error: 'Noget gik galt. Prøv venligst igen.',
    close: 'Luk',
    no_spam: 'Ingen spam. Afmeld med ét klik, når som helst.',
  },
  no: {
    eyebrow: 'Før du går',
    heading: 'Se nye boliger først',
    sub: 'Nye boliger i sameie legges ut nesten hver uke, og de beste andelene går raskt. Legg igjen kontaktinformasjonen din, så sender vi deg en e-post når noe nytt dukker opp.',
    email_placeholder: 'Din e-postadresse',
    phone_placeholder: 'Telefonnummer (valgfritt)',
    btn_idle: 'Hold meg oppdatert →',
    btn_sending: 'Sender…',
    success_heading: 'Du står på listen',
    success_msg: 'Vi tar kontakt så snart noe nytt legges ut.',
    error: 'Noe gikk galt. Prøv igjen.',
    close: 'Lukk',
    no_spam: 'Ingen spam. Meld deg av med ett klikk, når som helst.',
  },
};
