...
export const DESTINATIONS = [
  ...
  // ─── Spain — coastal costas ──────────────────────────────────────────────
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region cities (airport gateway + big visitor base = fire chip)
      'malaga', 'málaga',
      // Resort towns
  ...
  },
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region cities (Alicante = costa airport gateway + huge visitor base)
      'alicante', 'orihuela',
      // Resort towns
  ...
  },
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region gateway (Annecy = lake-and-ski hub, heavy visitor base)
      'annecy',
      // Ski resorts
      ...
      // Note: Grenoble (large metro, not really vacation-coded) still skipped
    ],
  },
  ...
  },
  {
    ...
    type: 'vacation',
    cities: [
      // Verona = airport gateway for Lake Garda visitors
      'verona',
      // Lakeside towns
  ...
  },
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region gateway cities (Florence + Pisa = airport gateways, visitor-heavy)
      'florence', 'firenze', 'pisa', 'lucca',
      // Hilltop & rural
      'siena', 'cortona', 'montepulciano', 'arezzo',
      ...
      // Coast (Versilia)
      'forte dei marmi', 'viareggio', 'porto santo stefano', 'punta ala',
    ],
  },
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region gateway cities
      'genoa', 'genova', 'la spezia', 'savona',
      // Riviera resorts
  ...
  },
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region gateway cities (Olbia = Costa Smeralda airport; Cagliari = south)
      'olbia', 'cagliari',
  ...
  // ─── Portugal ────────────────────────────────────────────────────────────
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region gateway cities (Faro = main Algarve airport)
      'faro', 'olhao', 'olhão',
      // Resort towns
  ...
  // ─── Austria — Alps only ────────────────────────────────────────────────
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region gateway (Innsbruck = winter sports capital + airport)
      'innsbruck',
      // Ski towns
  ...
  },
  {
    ...
    type: 'vacation',
    cities: [
      // Vacation-region gateway (Salzburg = Mozart tourism + airport + ski region)
      'salzburg',
      // Ski towns
