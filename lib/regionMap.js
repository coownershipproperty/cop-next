...
const REGION_MAP = {
  ...
  // France
  // "South of France" must never expand to a bare "France" — that matched
  // Alpine chalets in Morzine for someone who asked for the Riviera.
  'South of France':  ["Côte d'Azur", "Provence", "Languedoc", "Occitanie"],
  "Côte d'Azur":      ["Côte d'Azur"],
  'French Alps':      ["French Alps", "Portes du Soleil", "Trois Vallées", "Les 3 Vallées", "Courchevel", "Méribel", "Val Thorens",
                       "Chamonix", "Megève", "Tignes", "Val d'Isère", "Savoie", "Haute-Savoie", "Alpes"],
  'Paris':            ["Paris"],
  ...
  'Hamptons':         ["Hamptons", "New York", "New Jersey"],
