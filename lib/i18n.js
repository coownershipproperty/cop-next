...
export const LOCALE_META = {
  ...
  nl: { launched: false, notAvailable: 'Nog niet beschikbaar in het Nederlands', name: 'Nederlands', htmlLang: 'nl-NL', ogLocale: 'nl_NL', numberLocale: 'nl-NL', hreflangs: ['nl'],           currencyAfter: false, market: 'Netherlands / Flanders' },
  pt: { launched: false, notAvailable: 'Ainda não disponível em português', name: 'Português',  htmlLang: 'pt-BR', ogLocale: 'pt_BR', numberLocale: 'pt-BR', hreflangs: ['pt-BR', 'pt'],  currencyAfter: false, market: 'Brazil' },
  sv: { launched: false, notAvailable: 'Inte tillgänglig på svenska ännu', name: 'Svenska',    htmlLang: 'sv-SE', ogLocale: 'sv_SE', numberLocale: 'sv-SE', hreflangs: ['sv'],           currencyAfter: true,  market: 'Sweden' },
  da: { launched: false, notAvailable: 'Endnu ikke tilgængelig på dansk', name: 'Dansk',      htmlLang: 'da-DK', ogLocale: 'da_DK', numberLocale: 'da-DK', hreflangs: ['da'],           currencyAfter: true,  market: 'Denmark' },
  no: { launched: false, notAvailable: 'Ikke tilgjengelig på norsk ennå', name: 'Norsk',      htmlLang: 'nb-NO', ogLocale: 'nb_NO', numberLocale: 'nb-NO', hreflangs: ['nb', 'no'],     currencyAfter: true,  market: 'Norway' },
};
...
const ROUTE_SLUGS = {
  ...
  it: { home: '', howItWorks: 'comproprieta-casa-vacanze', aboutUs: 'chi-siamo', contact: 'contatti', homes: 'immobili', property: 'immobili', favourites: 'preferiti', blog: null, blogPost: null, glossary: null, destinations: null, towns: null, compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, pillar: null },
  nl: { home: '', howItWorks: 'mede-eigendom-vakantiewoning', aboutUs: 'over-ons', contact: 'contact', homes: 'woningen', property: 'woningen', favourites: 'favorieten', blog: null, blogPost: null, glossary: null, destinations: null, towns: null, compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, pillar: null },
  pt: { home: '', howItWorks: 'multipropriedade-casa-de-ferias', aboutUs: 'sobre-nos', contact: 'contato', homes: 'imoveis', property: 'imoveis', favourites: 'favoritos', blog: null, blogPost: null, glossary: null, destinations: null, towns: null, compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, pillar: null },
  sv: { home: '', howItWorks: 'samagande-fritidshus', aboutUs: 'om-oss', contact: 'kontakt', homes: 'bostader', property: 'bostader', favourites: 'favoriter', blog: null, blogPost: null, glossary: null, destinations: null, towns: null, compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, pillar: null },
  da: { home: '', howItWorks: 'medejerskab-feriebolig', aboutUs: 'om-os', contact: 'kontakt', homes: 'boliger', property: 'boliger', favourites: 'favoritter', blog: null, blogPost: null, glossary: null, destinations: null, towns: null, compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, pillar: null },
  no: { home: '', howItWorks: 'sameie-fritidsbolig', aboutUs: 'om-oss', contact: 'kontakt', homes: 'boliger', property: 'boliger', favourites: 'favoritter', blog: null, blogPost: null, glossary: null, destinations: null, towns: null, compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, pillar: null },
};
