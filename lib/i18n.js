...
const ROUTE_SLUGS = {
  en: { home: '', howItWorks: 'how-it-works',      aboutUs: 'about-us',    contact: 'contact', homes: 'our-homes',   property: 'property',      blog: 'all-our-blog', blogPost: 'blog',  favourites: 'favourites', glossary: 'glossary',    destinations: '',              towns: 'co-ownership',    compare: 'compare',       partners: 'partners',  buyingFaqs: 'buying-a-co-ownership-property-faqs',        stayingFaqs: 'staying-in-my-co-ownership-property-faqs',        listWithCop: 'list-with-cop', pillar: null },
  es: { home: '', howItWorks: 'como-funciona',     aboutUs: 'quienes-somos', contact: 'contacto', homes: 'propiedades', property: 'propiedades', blog: 'blog',         blogPost: 'blog',  favourites: 'favoritos',  glossary: 'glosario',    destinations: 'destinos',      towns: 'copropiedad',     compare: 'comparativa',   partners: 'socios',    buyingFaqs: 'comprar-copropiedad-preguntas-frecuentes',   stayingFaqs: 'disfrutar-copropiedad-preguntas-frecuentes',      listWithCop: null, pillar: 'copropiedad' },
  fr: { home: '', howItWorks: 'comment-ca-marche', aboutUs: 'a-propos',    contact: 'contact', homes: 'proprietes',  property: 'proprietes',    blog: 'blog',         blogPost: 'blog',  favourites: 'favoris',    glossary: 'glossaire',   destinations: 'destinations',  towns: 'copropriete',     compare: 'comparaison',   partners: 'partenaires', buyingFaqs: 'acheter-copropriete-questions-frequentes', stayingFaqs: 'profiter-copropriete-questions-frequentes',       listWithCop: null, pillar: 'copropriete-residence-secondaire' },
  de: { home: '', howItWorks: 'so-funktionierts',  aboutUs: 'ueber-uns',   contact: 'kontakt', homes: 'immobilien',  property: 'immobilien',    blog: 'blog',         blogPost: 'blog',  favourites: 'favoriten',  glossary: 'glossar',     destinations: 'destinationen', towns: 'miteigentum',     compare: 'vergleich',     partners: 'partner',   buyingFaqs: 'ferienimmobilie-kaufen-haeufige-fragen',     stayingFaqs: 'aufenthalt-ferienimmobilie-haeufige-fragen',      listWithCop: null, pillar: 'miteigentum-ferienimmobilie' },
  it: { home: '', howItWorks: 'comproprieta-casa-vacanze', aboutUs: 'chi-siamo', contact: 'contatti', homes: 'immobili', property: 'immobili', favourites: 'preferiti', blog: null, blogPost: null, glossary: null, destinations: null, towns: 'comproprieta', compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, listWithCop: null, pillar: null },
  nl: { home: '', howItWorks: 'mede-eigendom-vakantiewoning', aboutUs: 'over-ons', contact: 'contact', homes: 'woningen', property: 'woningen', favourites: 'favorieten', blog: null, blogPost: null, glossary: null, destinations: null, towns: 'mede-eigendom', compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, listWithCop: null, pillar: null },
  pt: { home: '', howItWorks: 'multipropriedade-casa-de-ferias', aboutUs: 'sobre-nos', contact: 'contato', homes: 'imoveis', property: 'imoveis', favourites: 'favoritos', blog: null, blogPost: null, glossary: null, destinations: null, towns: 'multipropriedade', compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, listWithCop: null, pillar: null },
  sv: { home: '', howItWorks: 'samagande-fritidshus', aboutUs: 'om-oss', contact: 'kontakt', homes: 'bostader', property: 'bostader', favourites: 'favoriter', blog: null, blogPost: null, glossary: null, destinations: null, towns: 'samagande', compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, listWithCop: null, pillar: null },
  da: { home: '', howItWorks: 'medejerskab-feriebolig', aboutUs: 'om-os', contact: 'kontakt', homes: 'boliger', property: 'boliger', favourites: 'favoritter', blog: null, blogPost: null, glossary: null, destinations: null, towns: 'medejerskab', compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, listWithCop: null, pillar: null },
  no: { home: '', howItWorks: 'sameie-fritidsbolig', aboutUs: 'om-oss', contact: 'kontakt', homes: 'boliger', property: 'boliger', favourites: 'favoritter', blog: null, blogPost: null, glossary: null, destinations: null, towns: 'sameie', compare: null, partners: null, buyingFaqs: null, stayingFaqs: null, listWithCop: null, pillar: null },
};
 ...
 */
/**
 * Round a listing price for display (David, 24 Sep 2026: "$99,038" reads as
 * too precise). Nearest 1,000; nearest 10,000 from 1m. Same rule as the
 * newsletter's formatPriceRounded. Admin and the Meta catalogue keep exact prices.
 */
export function roundPrice(amount) {
  const n = Number(amount);
  if (!Number.isFinite(n)) return amount;
  const step = n >= 1_000_000 ? 10_000 : 1_000;
...
export function formatPrice(amount, currency = 'EUR', locale = DEFAULT_LOCALE) {
  ...
  try {
    ...
    return `${currency} ${roundPrice(amount).toLocaleString('en-GB')}`;
  }
}
...
// ── Language switching ─────────────────────────────────────────────────────
//
// Until 22 Sep 2026 the redesigned nav (components/rd/Nav.js) sent every
// language choice to routePath(loc,'home'): a French reader on a property page
// who clicked EN landed on the English homepage, not that property in English.
// Header.js had the correct logic all along, but it lived inside that component
// and the redesign's own nav could not reach it. It lives here now, and both
// navs call it.
//
// Three cases, in order:
//   1. Dynamic-route page (property / blog post / town / destination) — the
//      slug is shared across locales, so swap the family prefix.
//   2. A page in ROUTE_MAP — resolve its canonical English key and look up the
//      target locale's own slug (/fr/proprietes/ → /es/propiedades/).
//   3. Neither — return null. The caller greys the language out rather than
//      linking to a 404.
//
// Every destination slug ends in one of these; used to tell an English
// destination URL (/{slug}/, root level) from every other root-level page.
const DESTINATION_SLUG_RE = /-fractional-ownership(-|$)/;

function stripLocalePrefixPath(path, locale) {
...
/** Detect a dynamic-route page and return {family, slug, prefixes}, or null. */
export function detectDynamicFamily(path, currentLocale) {
  if (LOCALE_ROOT_PATHS.has(path)) return null;
  for (const fam of DYNAMIC_URL_FAMILIES) {
    const prefix = fam.prefixes[currentLocale];
    if (!prefix) continue;
    if (currentLocale === DEFAULT_LOCALE && fam.family === 'destinations') {
...
/**
 * The equivalent of `currentPath` in `targetLocale`, or null when that locale
 * has no version of this page.
 *
 *   switchLocalePath('/fr/proprietes/', 'fr', 'es') → '/es/propiedades/'
 *   switchLocalePath('/property/casa-alba/', 'en', 'de') → '/de/immobilien/casa-alba/'
 *   switchLocalePath('/fr/', 'fr', 'sv') → '/sv/'
 */
export function switchLocalePath(currentPath, currentLocale, targetLocale) {
  const path = (currentPath || '/').split('?')[0].split('#')[0];
  if (targetLocale === currentLocale) return path;

  const dyn = detectDynamicFamily(path, currentLocale);
  if (dyn) {
    const prefix = dyn.prefixes[targetLocale];
    if (!prefix) return null;
    // FR has five country pillars, ES none, DE all 48 — never link to a 404.
    if (dyn.family === 'destinations' && !destinationAvailableIn(dyn.slug, targetLocale)) return null;
    return `${prefix}${dyn.slug}/`;
  }

  const englishPath = canonicalEnglishKey(path) || stripLocalePrefixPath(path, currentLocale);
  return localizedPath(englishPath, targetLocale) || null;
}
