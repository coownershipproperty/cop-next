...
const COPY = {
  ...
  de: {
    ...
    withMessage: "Ihre Fragen sind angekommen. Ich melde mich in Kürze mit Antworten auf jede einzelne.",
  ...
  it: {
    ...
    withMessage: "Ho ricevuto le Sue domande e Le rispondo a breve, una per una.",
  ...
  nl: {
    ...
    withMessage: "Ik heb uw vragen ontvangen en kom snel bij u terug met een antwoord op elke vraag.",
  ...
  pt: {
    ...
    withMessage: "Recebi as suas perguntas e volto a escrever-lhe em breve com a resposta a cada uma delas.",
