...
export const URL_PATHS = {
  en: { compare: '/compare', partners: '/partners', glossary: '/glossary' },
  es: { compare: '/es/comparativa', partners: '/es/socios', glossary: '/es/glosario' },
  fr: { compare: '/fr/comparaison', partners: '/fr/partenaires', glossary: '/fr/glossaire' },
  de: { compare: '/de/vergleich', partners: '/de/partner', glossary: '/de/glossar' },
};
