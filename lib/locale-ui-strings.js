...
const UI_STRINGS_BASE = {
  en: {
    ...
    guideEyebrow: 'Buyer’s Guide',
    guideLabel: 'Buyer’s guides',
  ...
  es: {
    ...
    guideEyebrow: 'Guía del Comprador',
    guideLabel: 'Guías del comprador',
  ...
  fr: {
    ...
    guideEyebrow: 'Guide de l’Acheteur',
    guideLabel: 'Guides de l’acheteur',
  ...
  de: {
    ...
    guideEyebrow: 'Käuferleitfaden',
    guideLabel: 'Käuferleitfäden',
...
export const URL_PATHS = {
  en: { compare: '/compare', partners: '/partners', glossary: '/glossary', faq: '/faq', guide: '/how-to-buy' },
  es: { compare: '/es/comparativa', partners: '/es/socios', glossary: '/es/glosario', faq: '/es/preguntas', guide: '/es/como-comprar' },
  fr: { compare: '/fr/comparaison', partners: '/fr/partenaires', glossary: '/fr/glossaire', faq: '/fr/questions', guide: '/fr/comment-acheter' },
  de: { compare: '/de/vergleich', partners: '/de/partner', glossary: '/de/glossar', faq: '/de/fragen', guide: '/de/so-kaufen-sie' },
};
