    ...
    parameters: {
      ...
      properties: {
        ...
        filters: {
          type: 'object',
          properties: {
            beds_min: { type: ['integer', 'null'] },
            beds_max: { type: ['integer', 'null'] },
            budget_max: { type: ['number', 'null'], description: 'Share price ceiling.' },
        ...
        weights: {
          type: 'object',
          description: 'Facet name -> -3..3, exactly as in the search intent: positive wants, negative avoids. Only facets the buyer implied.',
