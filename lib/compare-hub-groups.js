...
export const HUB_COPY = {
  en: {
    ...
    subtitle: 'Every question a buyer asks before committing, answered in one place and on the same facts for every operator, so these read like comparisons rather than advertisements.',
  ...
  es: {
    ...
    subtitle: 'Todas las preguntas que un comprador se hace antes de decidirse, respondidas en un mismo sitio y con los mismos datos. Escritas con los mismos datos para cada operador, por eso se leen como comparativas y no como anuncios.',
  ...
  fr: {
    ...
    subtitle: 'Toutes les questions qu’un acheteur se pose avant de s’engager, traitées au même endroit et sur les mêmes chiffres. Rédigées sur les mêmes chiffres pour chaque opérateur : c’est pourquoi ces pages se lisent comme des comparaisons et non comme des publicités.',
  ...
  de: {
    ...
    subtitle: 'Jede Frage, die sich Käufer vor der Entscheidung stellen, an einem Ort und auf derselben Zahlenbasis beantwortet. Für jeden Anbieter auf derselben Zahlenbasis geschrieben — deshalb lesen sich diese Seiten wie Vergleiche und nicht wie Anzeigen.',
