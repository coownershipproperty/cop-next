...
export const HUB_COPY = {
  en: {
    ...
    subtitle: 'Every question a buyer asks before committing, answered in one place and on the same facts. We list homes from six operators and are paid by none of them until something completes, which is why these read like comparisons rather than advertisements.',
  ...
  es: {
    ...
    subtitle: 'Todas las preguntas que un comprador se hace antes de decidirse, respondidas en un mismo sitio y con los mismos datos. Listamos viviendas de seis operadores y ninguno nos paga hasta que algo se cierra, y por eso esto se lee como una comparativa y no como un anuncio.',
  ...
  fr: {
    ...
    subtitle: 'Toutes les questions qu’un acheteur se pose avant de s’engager, traitées au même endroit et sur les mêmes chiffres. Nous référençons les biens de six opérateurs et aucun ne nous paie tant que rien n’est signé : c’est pourquoi ces pages se lisent comme des comparaisons et non comme des publicités.',
  ...
  de: {
    ...
    subtitle: 'Jede Frage, die sich Käufer vor der Entscheidung stellen, an einem Ort und auf derselben Zahlenbasis beantwortet. Wir listen Immobilien von sechs Anbietern und werden von keinem bezahlt, bevor nicht etwas abgeschlossen ist — deshalb lesen sich diese Seiten wie Vergleiche und nicht wie Anzeigen.',
