...
// The country pillars, in the order they are worth linking: most homes first.
// Exported so the footer builds its destination column from this file rather
// than keeping a second, hand-maintained copy of the same list — which is how
// it ended up linking to six of the eleven country pages that exist.
const COUNTRY_PILLARS = [
...
module.exports = { DESTINATIONS, COUNTRY_PILLARS };
