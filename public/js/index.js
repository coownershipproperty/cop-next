...
(function () {
    ...
    nav.querySelectorAll('a').forEach(function (a) {
        ...
        // Properties carousel — legacy Slick markup. The current React homepage
        // does not render this carousel, and it does not load jQuery.
        if (window.jQuery && document.getElementById('prop-list')) {
